...
<body>
	...
	<div class="main">
		...
		<div>
			...
			<span class="r_sto_name">작성자</span> <span class="r_sto_date">작성일</span>
		</div>
		<hr>
				...
				<c:when
					...
					<c:forEach var="store_review" items="${storeReviewList }">
						...
						<div>
							...
							<!-- 작성자 -->
							<div class="r_sto_name">${store_review.mem_id }</div>

							<!-- 작성일 -->
							<div class="r_sto_date">${store_review.sto_re_date }</div>
						</div>
						<hr>
					</c:forEach>
				</c:when>
