		...
		<form action="StoreReviewModifyPro.st" method="post">
			...
			<table>
				<tr>
					...
					<td><input type="text" name="mem_id" value="${sessionScope.sId }" id="mem_id" required="required" readonly="readonly"></td>
				</tr>
				<tr>
					<td>작성일</td>
					<td>${store_review.sto_re_date }</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea cols="50" rows="15" id="sto_re_content" name="sto_re_content" required="required">${store_review.sto_re_content }</textarea></td>
				</tr>
				<tr>
